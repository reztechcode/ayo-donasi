<nav class="text-white shadow-lg bg-primaryy sticky top-0 z-50">
    <div class="container mx-auto px-4 flex justify-between items-center py-4">
        ...
        <div id="menu" class="hidden md:flex space-x-2 text-white font-bold">
            ...
            <a href="#" class="hover:bg-slate-200 hover:text-sky-950 hover:rounded-full py-2 px-4">Tentang Kami</a>
        </div>

        <!-- Tombol Login dan Daftar -->
        <div class="space-x-3  hidden  md:flex">
            <a href="#" class="py-2 px-4 text-md w-24 text-center text-white rounded-full font-semibold">Login</a>
            <a href="#" class="bg-sky-900 py-2 px-4 w-32 text-center text-md text-white shadow-xl rounded-full font-semibold">
    ...
    <div class="bg-blue-100 lg:hidden md:hidden">
        <nav class="fixed bottom-0 inset-x-0 bg-primaryy text-white z-50">
            <div class="container mx-auto px-4 flex justify-between items-center py-3">
                ...
                <!-- Profile -->
                <a href="#" class="flex flex-col items-center hover:text-gray-200"> <i class="fa-solid fa-user"></i>
